<template>
  ...
  const handleSubmit = async () => {
    ...
    onMounted(async () => {
        ...
        form.value.company.name = response.data.company.name;
        form.value.company.description = response.data.company.description;
        form.value.company.contactEmail = response.data.company.contactEmail;
        form.value.company.contactPhone = response.data.company.contactPhone;
